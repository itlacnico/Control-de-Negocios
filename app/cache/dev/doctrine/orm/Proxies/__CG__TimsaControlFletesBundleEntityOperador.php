 ...
 */
class Operador extends \Timsa\ControlFletesBundle\Entity\Operador implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'nombre', 'RC', 'CURP', 'fecha_ingreso', 'statusA', 'actividad', 'fecha_deprecated', 'telefono', 'imagen', 'relacion');
    }
