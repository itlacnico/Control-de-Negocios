...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'security.firewall.map.context.aplicacion' => 'getSecurity_Firewall_Map_Context_AplicacionService',
            ...
            'sonata.admin.economico' => 'getSonata_Admin_EconomicoService',
            ...
            'sonata.admin.operador' => 'getSonata_Admin_OperadorService',
            ...
            'sonata.admin.relacion' => 'getSonata_Admin_RelacionService',
            'sonata.admin.role' => 'getSonata_Admin_RoleService',
            ...
            'sonata.admin.socio' => 'getSonata_Admin_SocioService',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/xampp/htdocs/TimsaLzc/app/cache/dev/annotations', true);
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/xampp/htdocs/TimsaLzc/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'timsa_lzc', 'host' => '127.0.0.1', 'port' => 3306, 'user' => 'root', 'password' => 'esparta12', 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_e8c957f2ed3c197c593942c79f8ff4ab');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_e8c957f2ed3c197c593942c79f8ff4ab');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_e8c957f2ed3c197c593942c79f8ff4ab');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => 'C:\\xampp\\htdocs\\TimsaLzc\\src\\Timsa\\ControlFletesBundle\\Entity')), 'Timsa\\ControlFletesBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('TimsaControlFletesBundle' => 'Timsa\\ControlFletesBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir('C:/xampp/htdocs/TimsaLzc/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/xampp/htdocs/TimsaLzc/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/xampp/htdocs/TimsaLzc/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/xampp/htdocs/TimsaLzc/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'C:/xampp/htdocs/TimsaLzc/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'C:/xampp/htdocs/TimsaLzc/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Timsa\\ControlFletesBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha1', 1 => false, 2 => 1))));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.aplicacion' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/main'))), $this->get('event_dispatcher'));
    }

    /**
     * Gets the 'security.firewall.map.context.aplicacion' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSecurity_Firewall_Map_Context_AplicacionService()
    {
        ...
        $k->setProviderKey('aplicacion');

        return $this->services['security.firewall.map.context.aplicacion'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($h, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.administradores')), 'aplicacion', $a, $c), 2 => $j, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $i, 'aplicacion', $k, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $i, array('login_path' => 'login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $a), array('check_path' => 'login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c), 4 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $h, $f, $a)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $i, 'aplicacion', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $i, 'login', false), NULL, NULL, $a));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/xampp/htdocs/TimsaLzc/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:/xampp/htdocs/TimsaLzc/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('C:/xampp/htdocs/TimsaLzc/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/xampp/htdocs/TimsaLzc/app/cache/dev/sessions');
    }
    ...
    /**
     * Gets the 'sonata.admin.economico' service.
     *
     * @return Timsa\ControlFletesBundle\Admin\EconomicoAdmin A Timsa\ControlFletesBundle\Admin\EconomicoAdmin instance.
     */
    protected function getSonata_Admin_EconomicoService()
    {
        $instance = new \Timsa\ControlFletesBundle\Admin\EconomicoAdmin('sonata.admin.economico', 'Timsa\\ControlFletesBundle\\Entity\\Economico', 'TimsaControlFletesBundle:Admin');
    ...
    /**
     * Gets the 'sonata.admin.operador' service.
     *
     * @return Timsa\ControlFletesBundle\Admin\OperadorAdmin A Timsa\ControlFletesBundle\Admin\OperadorAdmin instance.
     */
    protected function getSonata_Admin_OperadorService()
    {
        $instance = new \Timsa\ControlFletesBundle\Admin\OperadorAdmin('sonata.admin.operador', 'Timsa\\ControlFletesBundle\\Entity\\Operador', 'TimsaControlFletesBundle:Admin');
    ...
    {
        $this->services['sonata.admin.pool'] = $instance = new \Sonata\AdminBundle\Admin\Pool($this, 'Timsa', 'images/logo.png', array('html5_validate' => true, 'confirm_exit' => true));

        $instance->setTemplates(array('layout' => 'SonataAdminBundle::standard_layout.html.twig', 'user_block' => 'SonataAdminBundle:Core:user_block.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'edit' => 'SonataAdminBundle:CRUD:edit.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision' => 'SonataAdminBundle:CRUD:history_revision.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'list_block' => 'SonataAdminBundle:Block:block_admin_list.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig'));
        $instance->setAdminServiceIds(array(0 => 'sonata.admin.socio', 1 => 'sonata.admin.user', 2 => 'sonata.admin.operador', 3 => 'sonata.admin.role', 4 => 'sonata.admin.economico', 5 => 'sonata.admin.relacion'));
        $instance->setAdminGroups(array('Principales' => array('label' => 'Principales', 'label_catalogue' => 'SonataAdminBundle', 'items' => array(0 => 'sonata.admin.socio', 1 => 'sonata.admin.operador', 2 => 'sonata.admin.economico', 3 => 'sonata.admin.relacion')), 'Usuarios' => array('label' => 'Usuarios', 'label_catalogue' => 'SonataAdminBundle', 'items' => array(0 => 'sonata.admin.user', 1 => 'sonata.admin.role'))));
        $instance->setAdminClasses(array('Timsa\\ControlFletesBundle\\Entity\\Socio' => 'sonata.admin.socio', 'Timsa\\ControlFletesBundle\\Entity\\User' => 'sonata.admin.user', 'Timsa\\ControlFletesBundle\\Entity\\Operador' => 'sonata.admin.operador', 'Timsa\\ControlFletesBundle\\Entity\\Role' => 'sonata.admin.role', 'Timsa\\ControlFletesBundle\\Entity\\Economico' => 'sonata.admin.economico', 'Timsa\\ControlFletesBundle\\Entity\\Relacion' => 'sonata.admin.relacion'));

        return $instance;
    }

    /**
     * Gets the 'sonata.admin.relacion' service.
     *
     * @return Timsa\ControlFletesBundle\Admin\RelacionAdmin A Timsa\ControlFletesBundle\Admin\RelacionAdmin instance.
     */
    protected function getSonata_Admin_RelacionService()
    {
        $instance = new \Timsa\ControlFletesBundle\Admin\RelacionAdmin('sonata.admin.relacion', 'Timsa\\ControlFletesBundle\\Entity\\Relacion', 'TimsaControlFletesBundle:Admin');
    ...
    /**
     * Gets the 'sonata.admin.role' service.
     *
     * @return Timsa\ControlFletesBundle\Admin\RoleAdmin A Timsa\ControlFletesBundle\Admin\RoleAdmin instance.
     */
    protected function getSonata_Admin_RoleService()
    {
        $instance = new \Timsa\ControlFletesBundle\Admin\RoleAdmin('sonata.admin.role', 'Timsa\\ControlFletesBundle\\Entity\\Role', 'TimsaControlFletesBundle:Admin');
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'sonata.admin.socio', 1 => 'sonata.admin.user', 2 => 'sonata.admin.operador', 3 => 'sonata.admin.role', 4 => 'sonata.admin.economico', 5 => 'sonata.admin.relacion'), $this);
    }
    ...
    /**
     * Gets the 'sonata.admin.socio' service.
     *
     * @return Timsa\ControlFletesBundle\Admin\SocioAdmin A Timsa\ControlFletesBundle\Admin\SocioAdmin instance.
     */
    protected function getSonata_Admin_SocioService()
    {
        $instance = new \Timsa\ControlFletesBundle\Admin\SocioAdmin('sonata.admin.socio', 'Timsa\\ControlFletesBundle\\Entity\\Socio', 'TimsaControlFletesBundle:Admin');

        $instance->setTranslationDomain('YourNSAdminBundle');
        $instance->setManagerType('orm');
        $instance->setModelManager($this->get('sonata.admin.manager.orm'));
        $instance->setFormContractor($this->get('sonata.admin.builder.orm_form'));
        $instance->setShowBuilder($this->get('sonata.admin.builder.orm_show'));
     ...
     *
     * @return Timsa\ControlFletesBundle\Admin\UserAdmin A Timsa\ControlFletesBundle\Admin\UserAdmin instance.
     */
    protected function getSonata_Admin_UserService()
    {
        $instance = new \Timsa\ControlFletesBundle\Admin\UserAdmin('sonata.admin.user', 'Timsa\\ControlFletesBundle\\Entity\\User', 'TimsaControlFletesBundle:Admin');
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/xampp/htdocs/TimsaLzc/app', 'UTF-8');
    }
    ...
    protected function getTemplating_Helper_LogoutUrlService()
    {
        ...
        $instance->registerListener('aplicacion', 'logout', 'logout', '_csrf_token', NULL);
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'C:/xampp/htdocs/TimsaLzc/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'C:/xampp/htdocs/TimsaLzc/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\xampp\\htdocs\\TimsaLzc\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('C:\\xampp\\htdocs\\TimsaLzc\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('C:\\xampp\\htdocs\\TimsaLzc\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('C:\\xampp\\htdocs\\TimsaLzc\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('C:\\xampp\\htdocs\\TimsaLzc\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('C:\\xampp\\htdocs\\TimsaLzc\\src\\Timsa\\ControlFletesBundle/Resources/views', 'TimsaControlFletes');
        $instance->addPath('C:\\xampp\\htdocs\\TimsaLzc\\vendor\\sonata-project\\block-bundle\\Sonata\\BlockBundle/Resources/views', 'SonataBlock');
        $instance->addPath('C:\\xampp\\htdocs\\TimsaLzc\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/views', 'SonataAdmin');
        $instance->addPath('C:\\xampp\\htdocs\\TimsaLzc\\vendor\\sonata-project\\doctrine-orm-admin-bundle\\Sonata\\DoctrineORMAdminBundle/Resources/views', 'SonataDoctrineORMAdmin');
        $instance->addPath('C:\\xampp\\htdocs\\TimsaLzc\\src\\Acme\\DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('C:\\xampp\\htdocs\\TimsaLzc\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('C:\\xampp\\htdocs\\TimsaLzc\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('C:/xampp/htdocs/TimsaLzc/app/Resources/views');
        $instance->addPath('C:\\xampp\\htdocs\\TimsaLzc\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
        $instance->addPath('C:\\xampp\\htdocs\\TimsaLzc\\vendor\\knplabs\\knp-menu\\src\\Knp\\Menu/Resources/views');
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/xampp/htdocs/TimsaLzc/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:/xampp/htdocs/TimsaLzc/app/cache/dev/assetic/assets');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('security.user.provider.concrete.administradores'), new \Symfony\Component\Security\Core\User\UserChecker(), 'aplicacion', $this->get('security.encoder_factory'), true)), true);
    ...
    {
        return $this->services['security.user.provider.concrete.administradores'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'TimsaControlFletesBundle:User', 'username', NULL);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/xampp/htdocs/TimsaLzc/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:/xampp/htdocs/TimsaLzc/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/xampp/htdocs/TimsaLzc/app/cache/dev',
            'kernel.logs_dir' => 'C:/xampp/htdocs/TimsaLzc/app/logs',
            'kernel.bundles' => array(
                ...
                'TimsaControlFletesBundle' => 'Timsa\\ControlFletesBundle\\TimsaControlFletesBundle',
            ...
            'database_port' => 3306,
            'database_name' => 'timsa_lzc',
            'database_user' => 'root',
            'database_password' => 'esparta12',
            ...
            'debug.container.dump' => 'C:/xampp/htdocs/TimsaLzc/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => 'C:/xampp/htdocs/TimsaLzc/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => 'C:\\xampp\\htdocs\\TimsaLzc\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml',
            ),
            'validator.mapping.loader.yaml_files_loader.mapping_files' => array(
                0 => 'C:\\xampp\\htdocs\\TimsaLzc\\src\\Timsa\\ControlFletesBundle\\Resources\\config\\validation.yml',
            ),
            ...
            'profiler.storage.dsn' => 'file:C:/xampp/htdocs/TimsaLzc/app/cache/dev/profiler',
            ...
            'router.resource' => 'C:/xampp/htdocs/TimsaLzc/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/xampp/htdocs/TimsaLzc/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/xampp/htdocs/TimsaLzc/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/xampp/htdocs/TimsaLzc/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'C:/xampp/htdocs/TimsaLzc/app/../web',
            'assetic.write_to' => 'C:/xampp/htdocs/TimsaLzc/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'C:/xampp/htdocs/TimsaLzc/app/cache/dev/doctrine/orm/Proxies',
