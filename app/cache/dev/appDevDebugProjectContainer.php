...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'timsa_lzc', 'host' => '127.0.0.1', 'port' => 3306, 'user' => 'root', 'password' => 'esparta12', 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'swiftmailer.spool.memory.path' => 'C:/xampp/htdocs/TimsaLzc/app/cache/dev/swiftmailer/spool',
